        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="kaybanner container rounded text-white">
                    <div class="p-lg-5">
                        <h1>L'informatique pour tous</h1>
                        <p> Etudiez l'informatique chez vous, sur votre SmartPhone sur votre Ordinateur portable quand vous voulez où vous voulez</p>
            ...
            <div class="mt-3">
                ...
                @guest
                    @if (Route::has('register'))
                        <a class="btn pbtn-primary shadow" href="{{ route('register') }}">{{ __("S'inscrire") }}</a>
                    @endif
                @else
                    ...
                    <div class="col-lg-6">
                        <div class="container mt-4">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <div class="mt-3">
                                    <a href="about.php" class="btn pbtn-primary shadow pl-lg-5 pr-lg-5">En savoir plus</a>
                                </div>
                            </ul>
                        </div>
                    </div>
...
<div class="container-formations" style="margin-top:150px;margin-bottom:150px;">
    <div class="row">
        <div class="col-lg-3">
            ...
            <div class="mt-3">
                <a href="formations.php" style="letter-spacing:2px;" class="btn shadow pl-lg-5 pr-lg-5">Toutes les formations</a>
            </div>
        </div>
        <div class="col-lg-9">
