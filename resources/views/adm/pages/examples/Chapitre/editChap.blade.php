        ...
        <div class="card card-primary">
          ...
          <form action="{{ route('chapitre.update', $chapitre->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="titre_chapitre" value="{{$chapitre->titre_chapitre}}" name="titre_chapitre" class="form-control @error('titre_chapitre') is-invalid @enderror">
              ...
              <div class="card card-secondary">
                ...
                <div class="form-group">
                    <div class="card-body">
                        ...
                        <input type="text" id="videos" value="{{$chapitre->videos}}" name="videos" class="form-control @error('videos') is-invalid @enderror">
                        @error('videos')
                        <div class="is-invalid">
                            {{ $errors->first('videos')}}
                        </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input type="submit" value="Editer" class="btn btn-success float-right">
            </div>
          </div>
        </form>
      </div>
