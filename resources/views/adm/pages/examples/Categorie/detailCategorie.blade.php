  ...
  <!-- Default box -->
    <div class="card">
      ...
      <div class="card-body p-0">
        <h1>Voici les cours que nous offrons dans la catégorie {{$categorie->nom_categorie}}</h1>
              ...
              <tr>
                ...
                <td class="project-actions text-right">
                    <form action="{{ route('cours.destroy', $cours->id) }}" method="POST">
                      ...
                      <a class="btn btn-primary btn-sm" href="{{route('cours.edit', $categorie->id)}}">
