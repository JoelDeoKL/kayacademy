      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview menu-open">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="/cours" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>Cours</p>
              </a>
            </li>
...
<div class="content-wrapper">
  ...
  <!-- Default box -->
    ...
    <!-- /.card -->
<div>
  <a href="/cours/create" class="btn btn-primary my-3">Ajouter un cours</a>
</div>

<div>
  <a href="/categorie" class="btn btn-primary my-3">Voir les Catgories</a>
</div>

<div>
  <a href="/module" class="btn btn-primary my-3">Voir les Modules</a>
</div>
